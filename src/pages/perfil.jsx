                ...
                <div class="card-perfil">
                    ...
                    <div class="card-perfil-info">
                        <div class="img-freelancer-perfil">
                            <img src="https://www.psicologo.com.br/wp-content/uploads/sou-uma-pessoa-boa-ou-nao-768x403.jpg" alt="" />
                        </div>
                        <h3>{userAtivo}</h3>
                        <div class="card-info-dev-perfil">
                            <p>INFOR DO DEV <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="" /> NOME DO GIT </p>
                        </div>
                        <div class="card-info-dev-perfil">
                            <p>localização do dev <img src="https://png.pngtree.com/png-vector/20210216/ourlarge/pngtree-location-icon-in-flat-style-png-image_2914820.jpg" alt="" /></p>
                        </div>
                    </div>
                    <div class="enfeite2">
                        <img src={Efect2} />
                ...
                <div class="screen3">
                    <div class="certificacoes">
                        ...
                        <div class="certificado-info">
                            <img src="https://apexensino.com.br/wp-content/uploads/2020/05/26-java-logo.jpg" />
                    ...
                    <div class="matchs">
...

                        {
                            matchs.map(match => (
                                <CardMatch
                                idContactor={match.idContactor}
                                fkContactor={match.fkContactor}
                                idFreelancer={match.idFreelancer}
                                fkFreelancer={match.fkFreelancer}
                                />
                            ))
                        }
                    </div>
